 ...
 * @method \yii\db\BatchQueryResult|\app\models\AuthItem[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\AuthItem[] batch($batchSize = 100, $db = null)
 */
