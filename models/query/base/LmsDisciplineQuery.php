...
/**
 * This is the ActiveQuery class for \app\models\LmsDiscipline
 * @see \app\models\LmsDiscipline
 * @method \yii\db\BatchQueryResult|\app\models\LmsDiscipline[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\LmsDiscipline[] batch($batchSize = 100, $db = null)
 */
class LmsDisciplineQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
	...
	/**
	 * @inheritdoc
	 * @return \app\models\LmsDiscipline[]
	 */
