 ...
 * @method \yii\db\BatchQueryResult|\app\models\Comment[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\Comment[] batch($batchSize = 100, $db = null)
 */
class CommentQuery extends ActiveQuery
{
	...
	{
		return $this->andWhere(['{{%comment}}.[[deleted_at]]' => null]);
	}
