 ...
 * @method \yii\db\BatchQueryResult|\app\models\Course[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\Course[] batch($batchSize = 100, $db = null)
 */
class CourseQuery extends ActiveQuery
{
	...
	{
		return $this->andWhere(['{{%course}}.[[deleted_at]]' => null]);
	}
