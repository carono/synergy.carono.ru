...
/**
 * This is the ActiveQuery class for \app\models\LmsVideo
 * @see \app\models\LmsVideo
 * @method \yii\db\BatchQueryResult|\app\models\LmsVideo[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\LmsVideo[] batch($batchSize = 100, $db = null)
 */
class LmsVideoQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
