 ...
 * @method \yii\db\BatchQueryResult|\app\models\AuthItemChild[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\AuthItemChild[] batch($batchSize = 100, $db = null)
 */
class AuthItemChildQuery extends ActiveQuery
{
	...
	/**
	 * @inheritdoc
	 * @return \app\models\AuthItemChild[]
	 */
