 ...
 * @method \yii\db\BatchQueryResult|\app\models\Semester[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\Semester[] batch($batchSize = 100, $db = null)
 */
class SemesterQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
	...
	{
		return $this->andWhere(['{{%semester}}.[[deleted_at]]' => null]);
	}
