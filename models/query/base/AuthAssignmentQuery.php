 ...
 * @method \yii\db\BatchQueryResult|\app\models\AuthAssignment[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\AuthAssignment[] batch($batchSize = 100, $db = null)
 */
class AuthAssignmentQuery extends ActiveQuery
{
	...
	/**
	 * @inheritdoc
	 * @return \app\models\AuthAssignment[]
	 */
