...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['baseControllerClass', 'indexWidgetType'], 'required'],
            [
    ...
    public function beforeValidate()
    {
        if ($this->model) {
            ...
            $this->searchModelClass = $this->searchModelClass ?: '\app\models\search\\' . $reflection->getShortName() . 'Search';
            $this->controllerClass = $this->controllerClass ?: '\app\controllers\\' . $reflection->getShortName() . 'Controller';
            $this->baseControllerClass = CrudController::class;
        }
