...
На основе проведенного анализа выше предложите способы решения выявленных проблем в ходе выполнения выбранной Вами кейс-задачи.',
        'action' => 'case5',
        'comment' => 'Для анализа я выберу первый кейс, потому что: 

* Демонстрация наследования слишком тривиальна, интересного тут ничего нет
* По базе данных можно очень много фантазировать о том, чего не известно по ТЗ
* По своему web-приложению у меня очень много замечаний и идей, хватит на небольшую курсовую работу :D

Первый же кейс больше похож на стандартный код-ревью с небольшими вариациями',
    ],
];